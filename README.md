...
6. **OFB (XOR-based)** – simple block cipher in OFB mode with deterministic IV
7. **CTR (XOR-based)** – simple block cipher in CTR mode with deterministic nonce
8. **RSA** – classic public/private key encryption using small primes for learning

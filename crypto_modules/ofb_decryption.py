# OFB Decryption (matching the simple XOR-based encryption)
from .utils import DEFAULT_SEED, generate_lcg_bytes
from .ofb_encryption import BLOCK_SIZE, xor_bytes
...
def decrypt_blocks(data: bytes, key: bytes, iv: bytes) -> bytes:
    ...
    for i in range(0, len(data), BLOCK_SIZE):
        ...
        # Encrypt the feedback to generate keystream (same as encryption)
